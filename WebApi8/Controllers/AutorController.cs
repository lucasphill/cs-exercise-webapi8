...
public class AutorController : ControllerBase
{
    ...
    public async Task<ActionResult<ResponseModel<List<AutorModel>>>> ListarAutores() // chamando o metodo listar autores do serviço
    {
...
/* 
* quais metodos são necessários na interface
* implementar os metodos no serviço
* chamar os métodos na controller
*/